            ...
            async.waterfall([
                    ...
                    function (deviceInfo, innerCallback) {
                        ...
                        if (message.eventTag === "EVENT_DEV_MEBOOST_POWERON_REPORT") {
                            ...
                            switch (message.eventData.status) {
                                case 0x0001: {
                                    updateMessage.payload.parameters["status.switch"] = "ECO";
                                    updateMessage.payload.parameters["extra.items.mode"] = "ECO";
                                    event.eventDescription = "device switch into ECO";
                                }
                                    break;
                                case 0x0002: {
                                    updateMessage.payload.parameters["status.switch"] = "MAN";
                                    updateMessage.payload.parameters["extra.items.mode"] = "MAN";
                                    event.eventDescription = "device switch into MAN";
                                }
                                    break;
                                case 0x0003: {
                                    updateMessage.payload.parameters["extra.items.status"] = "FIN";
                                    event.eventDescription = "device switch into FIN";
                                }
                                    break;
                                case 0x0004: {
                                    updateMessage.payload.parameters["status.switch"] = "OFF";
                                    event.eventDescription = "device power off";
                                }
                                    break;
                                case 0x0005: {
                                    updateMessage.payload.parameters["status.switch"] = "ECO";
                                    updateMessage.payload.parameters["extra.items.status"] = "ADJ";
                            ...
                            event.eventDescription = "device power report to " + message.eventData.power;
                            self.message({
                                devices: self.configurator.getConfRandom("services.device_manager"),
                                payload: {
                                    cmdName: "deviceUpdate",
